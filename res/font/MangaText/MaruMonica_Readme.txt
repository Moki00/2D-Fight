...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
マルモニカはピクセルが形作る曲線美を追求した、丸ゴシック長体ピクセルフォントです。
ドット絵の技法とノウハウを活かしピクセル単位で8000を超えるグリフの字母を製作し、アウトラインフォント化したものです。

和文は文字数の把握と管理のしやすい等幅、欧文は自然な単語と文章を形作ることのできるプロポーショナル字幅としています。
キリル文字、ギリシャ文字についても全角の記号としてではなく、文章を組むことを目的に構成しています。

本テキストには利用規約やフォントの仕様、また便利な各グリフの一覧などを収めましたのでご活用下さい。
表示フォントをx12y16pxMaruMonica、文字サイズを96dpiの場合12pt、72dpiの場合16ptとすると、対応した表示環境であればピクセルの滲みのないビットマップ表示で字形を確認することができます。


【x12y16pxMaruMonica_Readme.txt】
...
【収録グリフ総数：8217】
各グリフは横書き時のバランスに特化して製作しており、縦書きでの運用は不可能ではありませんが想定していませんのでご了承下さい。
...
■ バージョンアップ履歴
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Version 2021-05-13　初版
Version 2021-05-19　MacOSで発生する文字内の塗り潰し不具合を解消
Version 2021-06-17　漢字の字形ミス修正とバランスの調整を実施（詳細は添付画像をご参照下さい）
...
ㇰㇱㇲㇳㇴㇵㇶㇷㇸㇹㇺㇻㇼㇽㇾㇿ（アイヌ語などのカタカナ表記用）
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
※このReadmeテキストの表示フォントをマルモニカにすることで表示されます。
...
ゲームパッド関連グリフは記号として十分な視認性を確保するために、例外的に幅・高さともに16pxサイズをベースに製作しています。
...
その他にも多くの記号がマルモニカには実装されています。Windows環境であれば付属のcharmap.exeなどでお確かめ下さい。
...
■ スペース関連グリフ一覧
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
※視認するために2つの黒塗りフルブロックの間に挿入してあります。

█ █	U+0020 SPACE		4px	いわゆる「半角スペース」、マルモニカの全角幅の基準となる12pxに対して、その1/3の4px相当の幅を持っています。
█ █	U+00A0 NO-BREAK SPACE	4px	スペース箇所での自動的な改行を防ぐ特殊なスペースです。
█ █	U+2000 EN QUAD		8px	固定幅のENスペースです。
█ █	U+2001 EM QUAD		16px	固定幅のEMスペースです。
█ █	U+2002 EN SPACE		8px	ENスペース。欧文組版において N の文字と同じ幅を持つことに由来しますが、現在はEMスペースの1/2を意味します。
█ █	U+2003 EM SPACE		16px	EMスペース。欧文組版において M の文字と同じ幅を持つことに由来しますが、現在は文字の高さと同じ幅のスペースを意味します。【EM、EN系スペースの基準値】
█ █	U+2004 THREE-PER-EM SPACE	5px	1/3のEMスペースです。小数点以下を四捨五入し5px相当の幅としています。
█ █	U+2005 FOUR-PER-EM SPACE	4px	1/4のEMスペースです。
█ █	U+2006 SIX-PER-EM SPACE	3px	1/6のEMスペースです。小数点以下を四捨五入し3px相当の幅としています。
█ █	U+2007 FIGURE SPACE	6px	図形間隔、数字幅のスペースです。0123456789と同じ幅を持っており、これはマルモニカでは全角スペースの1/2幅のスペースにもあたります。
█ █	U+2008 PUNCTUATION SPACE	3px	句読点スペースです。ピリオドなどと同じ幅を持ちます。
█ █	U+2009 THIN SPACE		2px	狭いスペースです。2px相当の幅を持ちます。
█ █	U+200A HAIR SPACE		1px	非常に狭いスペースです。マルモニカは場合によってグリフ同士の接触があるので、これが気になる場合に挿入することで1px相当の余白を設けることもできます。　例）激流 → 激 流
█​█	U+200B ZERO WIDTH SPACE	0px	ゼロ幅スペースです。視認することはできませんが、1文字として扱われるスペースです。
█　█	U+3000 IDEOGRAPHIC SPACE	12px	いわゆる「全角スペース」、和字間隔です。マルモニカにおいては16px相当の高さに対し、12px相当の幅を持ちます。

␣	U+2423: OPEN BOX		4px	空白記号。プログラミング等の入力内容を説明する際、スペース入力を明示するためのグリフです。通常のスペースと同等の4px相当の幅を持ちます。
...
■ おわりとはじまりに
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
約2年半に渡ったマルモニカの製作、多くの方々のご期待や助けをいただき完成に至ることができました。本当にありがとうございます。
ダウンロードして下さったあなたのお役に立ち、どなたかを楽しませるフォントとなることを願っています。

BOOTHで購入、BOOSTしていただいたお金は、フォントの製作と配布を続けていくため大切に使わせていただきます。
これからもピクセルフォントを活かしたゲームやコンテンツが生み出され、多くの人に愛されるために活動していきます。応援して頂けるとうれしいです！
